...
# 1. أولاً: نحدد عدد اللاعبين ونخرج من الحلقة
while True:
...
# 2. تعريف المتغيرات خارج حلقات التكرار
max_score = 50
players_score = [0 for _ in range(players)]

# 3. الحلقة الأساسية للعبة
